...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = "./det/model_data/yolox_s.pth"
    # ------------------------------------------------------#
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = "./M3FD_with_det/2007_train_rfn.txt"
    val_annotation_path = "./M3FD_with_det/2007_val_rfn.txt"
    ...
    if True:
        ...
        if local_rank == 0:
            eval_callback = EvalCallback(
                ...
                log_dir,
                Cuda,
                map_out_path=".temp_map_out_%s"%name,
                eval_flag=eval_flag,
                period=eval_period,
            )
        else:
